...
#define		_PIN(IO)			(IO ## _PIN)
#define		_PINMASK(IO)		(1U << (IO ## _PIN))
#define		_RPORT(IO)		(IO ## _RPORT)
#define		_WPORT(IO)		(IO ## _WPORT)
#define		_DDR(IO)			(IO ## _DDR)
...
#define		PINMASK(IO)		_PINMASK(IO)
#define		RPORT(IO)		_RPORT(IO)
#define		WPORT(IO)		_WPORT(IO)
#define		DDR(IO)			_DDR(IO)
